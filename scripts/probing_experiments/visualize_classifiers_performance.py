...
def create_classifier_comparison_plot(
    ...
    dataset_labels = {
        "split_squad_moe/probe/results": "SQuADv2",
        "split_trivia_moe/probe/results": "TriviaQA",
        "split_hotpotqa_moe/probe/results": "HotpotQA",
        "split_combined_moe/probe/results": "Combined",
    }
